...
// ─── EMAILJS CONFIG ─────────────────────────────────────────
// Servicio gratuito para envío de emails desde GitHub Pages (sin backend)
// Registro en https://www.emailjs.com · Plan gratuito: 200 emails/mes
const EMAIL_CONFIG = {
  serviceId: "service_RelavesMonitor",      // Reemplazar con tu Service ID de EmailJS
  templateId: "template_oqys9eg",    // Reemplazar con tu Template ID de EmailJS
  publicKey: "rX4EThTM1-x_e1KF1",  // Reemplazar con tu Public Key de EmailJS
  recipients: {
    primary: "andy5pulache.puescas@gmail.com",
    cc: "2020101796@ucss.pe"
  }
};
...
// ─── TABLA DE LECTURAS RAW DE SENSORES ──────────────────────
// Estos son los datos que en producción vendrían de los sensores físicos vía IoT.
// En la demo, el usuario puede editar estos valores para simular una lectura nueva
// y activar el sistema de detección + envío de email.
let SENSOR_READINGS = [
  {
    id: "SR001", sensor_id: "P1", sensor_name: "Piezómetro P1 - Talud Norte",
    kpi_id: "K09", kpi_name: "Presión P1 - Norte",
    timestamp: "2026-06-14 14:32:00",
    value: 78, unit: "kPa",
    raw_voltage: 1.245, signal_quality: 98,
    threshold_yellow: 100, threshold_red: 120,
    protocol: "LoRa 915MHz", frequency_min: 5, editable: true
  },
  {
    id: "SR002", sensor_id: "P4", sensor_name: "Piezómetro P4 - Talud Este",
    kpi_id: "K01", kpi_name: "Presión Intersticial P4",
    timestamp: "2026-06-14 14:32:15",
    value: 112, unit: "kPa",
    raw_voltage: 1.792, signal_quality: 95,
    threshold_yellow: 100, threshold_red: 120,
    protocol: "LoRa 915MHz", frequency_min: 5, editable: true
  },
  {
    id: "SR003", sensor_id: "P2", sensor_name: "Piezómetro P2 - Talud Sur",
    kpi_id: "K09", kpi_name: "Presión P2 - Sur",
    timestamp: "2026-06-14 14:32:10",
    value: 65, unit: "kPa",
    raw_voltage: 1.040, signal_quality: 97,
    threshold_yellow: 100, threshold_red: 120,
    protocol: "LoRa 915MHz", frequency_min: 5, editable: true
  },
  {
    id: "SR004", sensor_id: "P5", sensor_name: "Piezómetro P5 - Centro",
    kpi_id: "K09", kpi_name: "Presión P5 - Centro",
    timestamp: "2026-06-14 14:32:20",
    value: 58, unit: "kPa",
    raw_voltage: 0.928, signal_quality: 99,
    threshold_yellow: 100, threshold_red: 120,
    protocol: "LoRa 915MHz", frequency_min: 5, editable: true
  },
  {
    id: "SR005", sensor_id: "GPS1", sensor_name: "GPS RTK - Crestón",
    kpi_id: "K04", kpi_name: "Elevación Promedio",
    timestamp: "2026-06-14 06:00:00",
    value: 2454.3, unit: "m",
    raw_voltage: null, signal_quality: 100,
    threshold_yellow: 2460, threshold_red: 2465,
    protocol: "GPS RTK (GNSS)", frequency_min: 360, editable: true
  },
  {
    id: "SR006", sensor_id: "FLOW1", sensor_name: "Medidor de Caudal - Descarga",
    kpi_id: "K07", kpi_name: "Caudal de Descarga",
    timestamp: "2026-06-14 14:35:00",
    value: 143, unit: "m³/h",
    raw_voltage: 4.115, signal_quality: 100,
    threshold_yellow: 130, threshold_red: 120,
    protocol: "4-20mA / RS-485", frequency_min: 1, editable: true
  },
  {
    id: "SR007", sensor_id: "DENS1", sensor_name: "Densímetro - Línea Principal",
    kpi_id: "K05", kpi_name: "Densidad de Pulpa",
    timestamp: "2026-06-14 14:00:00",
    value: 1.48, unit: "t/m³",
    raw_voltage: 3.840, signal_quality: 100,
    threshold_yellow: 1.55, threshold_red: 1.6,
    protocol: "Modbus RTU", frequency_min: 15, editable: true
  },
  {
    id: "SR008", sensor_id: "MET1", sensor_name: "Estación Meteorológica",
    kpi_id: "K11", kpi_name: "Precipitación Acumulada 7d",
    timestamp: "2026-06-14 14:00:00",
    value: 42, unit: "mm",
    raw_voltage: null, signal_quality: 100,
    threshold_yellow: 50, threshold_red: 80,
    protocol: "4G/LTE", frequency_min: 60, editable: true
  },
  {
    id: "SR009", sensor_id: "MET1", sensor_name: "Estación Meteo - Nivel Piscina",
    kpi_id: "K10", kpi_name: "Nivel Piscina (Borde Libre)",
    timestamp: "2026-06-14 12:00:00",
    value: 0.82, unit: "m",
    raw_voltage: 2.624, signal_quality: 100,
    threshold_yellow: 0.7, threshold_red: 0.5,
    protocol: "4G/LTE", frequency_min: 60, editable: true
  },
  {
    id: "SR010", sensor_id: "P3", sensor_name: "Piezómetro P3 - Talud Este",
    kpi_id: "K09", kpi_name: "Presión P3 - Este",
    timestamp: "2026-06-14 14:30:05",
    value: 83, unit: "kPa",
    raw_voltage: 1.328, signal_quality: 62,
    threshold_yellow: 100, threshold_red: 120,
    protocol: "LoRa 915MHz", frequency_min: 5, editable: true
  },
];
